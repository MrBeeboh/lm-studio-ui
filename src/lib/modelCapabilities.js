...
export function getModelCapabilities(modelId) {
  ...
  const tools =
    ...
    /qwen2\.5|qwen2\.7|qwen3|llama[-.]?3\.1|llama[-.]?3\.2|llama[-.]?4|claude|gpt[-.]?4|mistral[-.]?large|command[-.]?r|deepseek|gemma|phi[-.]?4|minicpm[-.]?v?3|yi[-.]?1\.5|yi[-.]?2|schematron|ministral|glm[-.]?4/i.test(lower);
  // Thinking / reasoning (extended chain-of-thought, R1-style)
  const thinking =
    /\b(thinking|reasoning|chain[-.]?of[-.]?thought|cot)\b/.test(lower) ||
    /[-.]r1[-.]|deepseek[-.]?r1|phi[-.]?4[-.]?mini|qwen3[-.]?4b|glm[-.]?4/i.test(lower);
